...
function PlayState:enter(params)
    ...
    self.scoreGoal = self.level * 1.25 * 1000 --1.25
end
        ...
        if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
            ...
            elseif math.abs(self.highlightedTile.gridX - x) + math.abs(self.highlightedTile.gridY - y) > 1 then
                ...
                self.board.tiles[newTile.gridY][newTile.gridX] = newTile
                        ...
                        while(self.board:potentialMatches()==false) do
...
function PlayState:calculateMatches()
    ...
    if matches then
        ...
        for k, match in pairs(matches) do
            for a, t in pairs(match) do
                self.score = self.score +  t.variety * 50
            end
...
function PlayState:render()
    ...
    love.graphics.printf('x: ' .. tostring(self.board.spotx), 20, 130, 182, 'center')
    love.graphics.printf('y: ' .. tostring(self.board.spoty), 20, 150, 182, 'center')
end